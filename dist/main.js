...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"getFleet\": () => (/* binding */ getFleet)\n/* harmony export */ });\n/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index */ \"./src/index.js\");\n/* harmony import */ var _data__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./data */ \"./src/data.js\");\n\n\n\nlet shipSize = 5;\n\nfunction createShip() {\n    const random = () => Math.floor(Math.random() * 10);\n    let axis = getAxis();\n    let coords = random();\n    let item = [];\n\n    function getAxis() {\n        return random() % 2 == 0 ? \"row\" : \"column\";\n    }\n    \n    const getItem = (n) => {\n        if (axis == \"row\") {\n            if (coords < n) {\n                for (let i = n; i > 0; i--) {\n                    item.push(_data__WEBPACK_IMPORTED_MODULE_1__.y[coords] + _data__WEBPACK_IMPORTED_MODULE_1__.x[(coords + n)- i]);\n                }\n            } else {\n                for (let i = n; i > 0; i--) {\n                    item.push(_data__WEBPACK_IMPORTED_MODULE_1__.y[coords] + _data__WEBPACK_IMPORTED_MODULE_1__.x[coords- i]);\n                }\n            }\n\n        } else {\n            if (coords < 5){\n                for (let i = n; i > 0; i--) {\n                    item.push(_data__WEBPACK_IMPORTED_MODULE_1__.y[(coords + n)- i] + _data__WEBPACK_IMPORTED_MODULE_1__.x[coords]);\n                }\n            } else {\n                for (let i = n; i > 0; i--) {\n                    item.push(_data__WEBPACK_IMPORTED_MODULE_1__.y[coords - i] + _data__WEBPACK_IMPORTED_MODULE_1__.x[n]);\n                }\n            }\n        }\n    }\n\n    if (shipSize == 5) getItem(5);\n    else if (shipSize < 3) getItem(2);\n    else getItem(shipSize);\n\n    return item;\n}\n\nfunction test(arr, item) {\n    let res = [];\n    arr.forEach(e => {\n        if (e.some(x => item.includes(x))) res.push(true);\n    })\n\n    return res.includes(true);\n}\n\nfunction appendShip() {\n    let item = createShip();\n\n    if (shipSize == 5) {\n        _data__WEBPACK_IMPORTED_MODULE_1__.machineCoords.push(item);\n        shipSize--;\n    }\n    else {\n        if (test(_data__WEBPACK_IMPORTED_MODULE_1__.machineCoords, item) == false) {\n            _data__WEBPACK_IMPORTED_MODULE_1__.machineCoords.push(item)\n            shipSize--;\n        }\n    }\n    // console.table(machineCoords);\n}\n\nfunction getFleet() {\n    while (shipSize > 0) {\n        appendShip();\n    }\n    (0,_index__WEBPACK_IMPORTED_MODULE_0__.makeMove)();\n}\n\n\n\n//# sourceURL=webpack://battleship/./src/ia-fleet.js?");
